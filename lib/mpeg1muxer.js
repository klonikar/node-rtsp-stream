...
(function() {
  ...
  Mpeg1Muxer = function(options) {
    ...
    if(size == '') {
        lastParams = ["-re", "-i", this.url, '-f', 'mpeg1video', '-b:v', '800k', '-r', '30', '-'];
    }
    else {
        lastParams = ["-re", "-i", this.url, '-s', size ,'-f', 'mpeg1video', '-b:v', '800k', '-r', '30', '-'];
    }
    ...
    this.stream.on('close', function(code, sig) {
      return self.emit('ffmpegExit', {'code': code, 'signal': sig});
    });
    return this;
  };
